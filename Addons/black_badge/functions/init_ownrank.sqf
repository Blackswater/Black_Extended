		...
		switch (player call BIS_fnc_getUnitInsignia) do
			{
				...
				case "Gefreiter_UA": {Black_ownrank = "\black_badge\data\1\gefreiter_ua.paa"};
				case "Gefreiter_OA": {Black_ownrank = "\black_badge\data\1\gefreiter_oa.paa"};
				case "Fahnenjunker": {Black_ownrank = "\black_badge\data\1\fahnenjunker.paa"};
				case "Oberfaehnrich": {Black_ownrank = "\black_badge\data\1\oberfaehnrich.paa"};
				case "Faehnrich": {Black_ownrank = "\black_badge\data\1\faehnrich.paa"};
				case "PRIVATE_ARMY": {Black_ownrank = "\black_badge\data\0\0PVT.paa"};
				case "PRIVATE_FIRST_CLASS": {Black_ownrank = "\black_badge\data\0\1PFC.paa"};
				case "CORPORAL_ARMY": {Black_ownrank = "\black_badge\data\0\2CPL.paa"};
				case "SERGEANT_ARMY": {Black_ownrank = "\black_badge\data\0\3SGT.paa"};
				case "SERGEANT_ARMY": {Black_ownrank = "\black_badge\data\0\4SSG.paa"};
				case "SERGEANT_FIRST_CLASS": {Black_ownrank = "\black_badge\data\0\5SFC.paa"};
				case "STAFF_SERGEANT": {Black_ownrank = "\black_badge\data\0\6MSG.paa"};
				case "SECOND_LIEUTENANT": {Black_ownrank = "\black_badge\data\0\7LT.paa"};
				case "FIRST_LIEUTENANT": {Black = "\black_badge\data\0\8LTE.paa"};
				case "CAPTAIN_ARMY": {Black_ownrank = "\black_badge\data\0\9CPT.paa"};
				case "MAJOR_ARMY": {Black_ownrank = "\black_badge\data\0\10MJR.paa"};
				case "FIRST_SERGEANT": {Black_ownrank = "\black_badge\data\0\1SG.paa"};
				case "LIEUTENANT_COLONEL": {Black_ownrank = "\black_badge\data\0\11LTC.paa"};
				case "COLONEL_ARMY": {Black_ownrank = "\black_badge\data\0\12COL.paa"};
				case "": {Black_ownrank = "\black_badge\data\0\keinen.paa"};
			};
